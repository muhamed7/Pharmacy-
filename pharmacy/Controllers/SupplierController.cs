...
namespace pharmacy.Controllers
{
    public class SupplierController : Controller
    {
        ...
        {
            return View(db.Supplier.OrderByDescending(s=> s.ID ).ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Address,Contact,Description,Abbrevation")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Address,Contact,Description,Abbrevation")] Supplier supplier)
        {

            if (ModelState.IsValid && supplier != null)
            {

                var original = db.Supplier.Find(supplier.ID);
